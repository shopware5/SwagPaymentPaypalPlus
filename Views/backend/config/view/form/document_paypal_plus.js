...
Ext.define('Shopware.apps.Config.view.form.DocumentPaypalPlus', {
    ...
    alias: 'widget.config-form-document-paypal-plus',
    ...
    getFormItems: function() {
        ...
        data[1].items.push({
            ...
            labelWidth: 100,
            name: 'Paypal_Content_Info_Value',
            hidden: true,
            translatable: true
        }, {
            xtype: 'textarea',
            ...
            labelWidth: 100,
            name: 'Paypal_Content_Info_Style',
            hidden: true,
            translatable: true
        });
